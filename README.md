...
Download the dataset from Kaggle and place hotel_bookings.csv in the project folder
...
👩‍💻 Author
Samriddhi M.Sc. Statistics under supervision of Dr. Rohtash Bhardwaj — Punjabi University (2024–2026) Aspiring Data Analyst | R · Python · SQL · Excel · Power BI

GitHub

📄 License
This project is intended for academic and portfolio purposes. Dataset credit: Antonio, Almeida & Nunes (2019) via Kaggle.
